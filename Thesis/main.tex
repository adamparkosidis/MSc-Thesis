...
{ \huge \bfseries The evolution of $\xi$ Tau hierarchical triple system with a Roche lobe filling outer star }\\[0.8cm] % title of thesis
...
\input{Thesis/2.Background/Intro_chapter_1}

\input{Thesis/Methods/Intro_chapter_2}

%\input{Thesis/Chapter_3/Intro_chapter_3}

%\input{Thesis/Chapter_3.tex}
