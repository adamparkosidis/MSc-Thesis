...
{\large  \monthyeardate{\today}}\\ % month + year in which the thesis was concluded
%\DTMlangsetup{showdayofmonth=true}
{\large  \emph{60 ECTS}}\\ % 'this many' ects that are rewarded for the thesis
{\large  \emph{November 2022 - July 2023}}\\[1.8cm] % period in which the research was carried out
...
\input{Thesis/1.Introduction/Introduction}

\input{Thesis/2.Background/Intro_chapter_2}

\input{Thesis/3.Methods/Intro_chapter_3}

\input{Thesis/4.Simulations/Intro_chapter_4}

\input{Thesis/5.Discussion_Conclusions/Intro_chapter_5}
