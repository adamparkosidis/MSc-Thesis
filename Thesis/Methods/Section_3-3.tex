...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.495\textwidth}  
        ...
        \caption[]%
        {{\small Internal energies of the gas particles at  $t_{relax} = 5t_{dyn}$}}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[b]{0.495\textwidth}  
        \centering 
        \includegraphics[width=\textwidth]{Thesis/graphs/tertiary_internal_energy_relaxed_7_5_tdyn.pdf}
        \caption[]%
        {{\small Internal energies of the gas particles at  $t_{relax} = 7.5t_{dyn}$}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.495\textwidth}  
        \centering 
        \includegraphics[width=\textwidth]{Thesis/graphs/tertiary_internal_energy_relaxed_10_tdyn.pdf}
